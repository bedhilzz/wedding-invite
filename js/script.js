(function ($) {
  $(document).ready(function () {
    ...
    function send_form(type) {
      ...
      // Modify your code here #1
      var guest = "";
      // Modify your code here #2
      var phone = "";

      var dataString = "&entry.1114791129=" + name + "&entry.1548819706=" + email + "&entry.1824395540=" + guest + "&entry.760668402=" + phone;
      var form = $(this);
      ...
      $.ajax({
        type: "GET",
        url: "https://docs.google.com/forms/d/e/1FAIpQLSebbrw49V_sbUTdSBUWI1ZnsSHn2f2FnhWUJMe0uBu_8MQWug/formResponse",
        data: dataString + "&submit=Submit",
        complete: sent
      });
    }
    ...
    /*CountDown*/
    $('.marriage_countdown').countdown({ until: new Date("Dec 12, 2021 12:00:00") });
